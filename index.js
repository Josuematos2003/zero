...
const isOwner3 = sender.includes(dono) ? sender.includes(dono2):sender.includes(dono3);

const isOwner4 = sender.includes(dono) ? sender.includes(dono3):sender.includes(dono4);

const isOwner5 = sender.includes(dono) ? sender.includes(dono4):sender.includes(dono5);
