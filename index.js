...
// #settings.json
var { dono, dono2, dono3, dono4, dono5, dono6, numeroBot, grupoDono, nomeBot, nomeDonoY, botDisplay } = JSON.parse(fs.readFileSync('./edit/settings.json'))
...
const isOwner = sender.includes(dono) ? sender.includes(dono):sender.includes(dono2) ? sender.includes(dono):sender.includes(dono3) ? sender.includes(dono):sender.includes(dono4) ? sender.includes(dono):sender.includes(dono5) ? sender.includes(dono):sender.includes(dono6));
