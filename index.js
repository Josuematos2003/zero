...
// #settings.json
var { dono, dono2, dono3, dono4, dono5, dono6, dono7, numeroBot, grupoDono, nomeBot, nomeDonoY, botDisplay } = JSON.parse(fs.readFileSync('./edit/settings.json'))

if ((dono2 === 'undefined')) dono2 = '55' + '49' + '91579631';

if ((dono3 === 'undefined')) dono3 = '55' + '49' + '91579631';

if ((dono4 === 'undefined')) dono4 = '55' + '49' + '91579631';

if ((dono5 === 'undefined')) dono5 = '55' + '49' + '91579631';

if ((dono6 === 'undefined')) dono6 = '55' + '49' + '91579631';

if ((dono7 === 'undefined')) dono7 = '55' + '49' + '91579631';
//
...
const isOwner = sender.includes(dono) ? sender.includes(dono):sender.includes(dono2) ? sender.includes(dono):sender.includes(dono3) ? sender.includes(dono):sender.includes(dono4) ? sender.includes(dono):sender.includes(dono5) ? sender.includes(dono):sender.includes(dono6) ? sender.includes(dono):sender.includes(dono7);
