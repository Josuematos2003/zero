...
// #settings.json
var { dono, dono2, dono3, dono4, numeroBot, grupoDono, nomeBot, nomeDonoY, botDisplay } = JSON.parse(fs.readFileSync('./edit/settings.json'))
...
const isOwner3 = sender.includes(dono3) ? sender.includes(dono3):sender.includes(dono3);

const isOwner4 = sender.includes(dono4) ? sender.includes(dono4):sender.includes(dono4);

const isOwner5 = sender.includes(dono5) ? sender.includes(dono5):sender.includes(dono5);
