...
const isOwner3 = sender.includes(dono) ? sender.includes(dono):sender.includes(dono3);

const isOwner4 = sender.includes(dono) ? sender.includes(dono):sender.includes(dono4);
